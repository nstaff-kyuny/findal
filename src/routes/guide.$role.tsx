...
const SEEKER_STEPS: Step[] = [
  ...
  { badge: "4", title: "출근 확정", desc: "근무 당일 출근 의사가 확실하다면 [✅ 출근 확정] 버튼을 눌러주세요. 구인자에게 출근 예정을 알리는 신호입니다." },
...
const EMPLOYER_STEPS: Step[] = [
  ...
  { badge: "5", title: "구직자 출근 확정", desc: "구직자가 [출근 확정]을 누르면 카드가 초록색으로 표시되어 출근 예정이 확실함을 알 수 있습니다." },
